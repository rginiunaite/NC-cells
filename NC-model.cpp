/*
IBM model for NC cells coupled to reaction-diffusion model for chemoattractant, model described in SI McLennan et al. (2018). Followers are guided by the leaders only by contact.
...
*/
    ...
    typedef Particles<std::tuple<radius, type, attached_to_id, direction, chain, chain_type, persistence_extent, same_dir_step>, 2> particle_type; 
